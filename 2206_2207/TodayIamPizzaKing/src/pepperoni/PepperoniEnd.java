...
class PepperoniEnd extends JDialog {
	
	private ImageIcon winImg = new ImageIcon("images/pepperoni/pep_win.png");
	private ImageIcon loseImg = new ImageIcon("images/pepperoni/pep_lose.png");
	JPanel jp;
	private JButton ok;
